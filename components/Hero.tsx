...
export function Hero() {
  return (
    <motion.div
      ...
      className="flex flex-col md:flex-row lg:flex-col gap-10 md:gap-8 lg:gap-10 h-full w-full items-start"
    >
      {/* ── Left Column (Tablet) / Top (Mobile/Desktop) ── */}
      <div className="flex flex-col gap-8 md:w-1/2 lg:w-full shrink-0">
        {/* ── Identity ── */}
      ...
      {/* ── Experience Timeline ── */}
      <motion.div variants={itemVariants} className="flex-1 md:w-1/2 lg:w-full min-w-0">
        <ExperienceTimeline />
      </motion.div>
    </motion.div>
  );
